...
//COMPIL :
//cmake ../GLImac-Template && make && ./TP4/TP4_exo3_rotation_matrice tex2D_3.vs.glsl tex2D_3.fs.glsl
...
int main(int argc, char** argv) {
    ...
    while(!done) {
        ...
        glUniformMatrix3fv(modelMatrixLocation, 1, GL_FALSE,  glm::value_ptr(rotate(angle)));
        angle += rotSpeed;
