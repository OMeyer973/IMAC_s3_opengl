...
//cmake ../GLImac-Template && make && ./TP7/TP7_exo2_freefly_cam
    ...
    while(!done) {
        ...
        while(windowManager.pollEvent(e)) {
            ...
            case SDL_MOUSEMOTION:                
                if (mouseDown) {
                    freeflyCamera.rotateLeft(e.button.x - mouseX);
                    freeflyCamera.rotateUp(e.button.y - mouseY);
                    mouseX = e.button.x;
                    mouseY = e.button.y;
                }
                break;
            ...
            case SDL_KEYDOWN:
                if (e.key.keysym.sym==122){ //z
                    freeflyCamera.moveFront(1);
                }
                 if (e.key.keysym.sym==115){ //s
                    freeflyCamera.moveFront(-1);
                }
                if (e.key.keysym.sym==113){ //q
                    freeflyCamera.moveLeft(1);
                }
                if (e.key.keysym.sym==100){ //d
                    freeflyCamera.moveLeft(-1);
                }
                if (e.key.keysym.sym==304){ //shift
                    freeflyCamera.moveUp(1);
                }
                if (e.key.keysym.sym==306){ //ctrl
                    freeflyCamera.moveUp(-1);
                }
                break;
